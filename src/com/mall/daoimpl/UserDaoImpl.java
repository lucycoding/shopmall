...
import com.mall.exception.NoMessageException;
...
public class UserDaoImpl implements UserDao{
	...
	public boolean addUser(User user) {
		...
		DbUtil dbUtil = null;
		String sql = "insert into tb_user values(null,?,?,?,?,null,null,null,null,null,null,?,?)";
		try {
			dbUtil = new DbUtil();
	...
	public boolean addNote(Note note){
		...
		PreparedStatement pstmt = null;
		DbUtil dbUtil = null;
		String sql = "insert into tb_note(id,title,author,content,ly_time) values(null,?,?,?,null)";
		try {
			dbUtil = new DbUtil();
			pstmt = dbUtil.getCon().prepareStatement(sql);
	...
	public Boolean updateUser(User user) {
		...
		DbUtil dao = new DbUtil();
		PreparedStatement pre = null;
		String sql = "update tb_user set  email = ? , trueName = ? , sex = ? , birthday = ? , address = ? , postcode = ? , phone = ? , mphone = ? , question = ? , answer = ?   where name = ?";
		try {
