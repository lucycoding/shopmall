  ...
  <body> 
				...
				<div class="row-fluid">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-zoom-in"></i>&nbsp;<a href="getOrderPagerServlet">所有订单</a></h2>
					...
					<table class="table table-striped table-bordered" id="user-table" style="font-size: 12px;">
								...
								<tr>
									...
									<c:set var="flag" value="${order.flag }"/> 
									<% Integer flag=(Integer)pageContext.getAttribute("flag");
									%>
									<td style="text-align:center;"><% if(flag==1) out.print("已发货");else if(flag==0) out.print("未发货");else out.print("已确认收货"); %></td>
