...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function unFreezeOrder(pageOffset,pageSize) {
			var deletes = document.getElementsByName("delete");
			var count = 0;
			var orders = new Array();
			for(var i = 0;i<deletes.length;i++) {
			...
			bootbox.confirm("确定解冻选中的订单?", function(flag) {
			if( flag ) {
				var oform = document.getElementsByTagName("form")[0];
				oform.action = "unFreezeOrderServlet?orderIds="+orders+"&pageOffset="+pageOffset+"&pageSize="+pageSize;
				oform.submit();
			}
			});
		}
  ...
  <body> 
				...
				<div class="row-fluid">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-ban-circle"></i>&nbsp;<a href="getOrderFreezePagerServlet">已确认收货订单</a></h2>
					...
					<table class="table table-striped table-bordered" id="user-table" style="font-size: 12px;">
								...
								<tr>
									...
									<td style="text-align:center;">已确认收货</td>
					 ...
					 <div class="pull-right">
					 	<!-- <a onclick="unFreezeOrder(${orderPager.pageOffset},${orderPager.pageSize})" href="javascript:;" class="btn btn-success"><i class="icon-ok-circle icon-white"></i>解冻</a>-->　
